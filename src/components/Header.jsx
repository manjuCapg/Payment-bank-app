...
export const Header = () => {
  return (
    <div className="flex items-center bg-green-800 p-4  shadow w-full">
      {/* Left: Logo (20%) */}
      <div className="w-1/4">
      ...
      <div className="w-4/5 flex justify-between items-center">
        ...
        <div className="w-1/2 flex justify-end items-center space-x-4">
          ...
          <button
           ...
           px-3 py-1 rounded text-white hover:bg-gray-700"
          >
